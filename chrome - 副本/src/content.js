...
const init = async function () {
  ...
  Object.assign(navigatorValues, {
    ...
    [BasicConf.newCanvas]: getBasicValue(bData[BasicConf.newCanvas], randomHardwareConcurrency),
    [BasicConf.GPU]: getBasicValue(bData[BasicConf.GPU], randomWebGLRandom),
